...
public interface ContractService {
	...
	/**
	 * @param mechanic dni
	 * @return a list with every ContractSummaryDto registered for this mechanic, probably empty
	 * @throws BusinessException DOES NOT
	 * @throws IllegalArgumentException when dni is null or empty.
	 */
	List<ContractSummaryDto> findContractsByMechanicDni(String mechanicDni) throws BusinessException;

	/**
	 * @return a list with every ContractSummaryDto registered, probably empty
	 * @throws BusinessException DOES NOT
	 * @throws IllegalArgumentException when id is null or empty.
	 */
